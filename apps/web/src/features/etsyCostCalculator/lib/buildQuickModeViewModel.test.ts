...
describe("buildQuickModeViewModel", () => {
  it("separates listed price from discounted product revenue in quick mode scenarios", () => {
    ...
    expect(view.breakEvenPriceUsd).toBe(32.42);
    expect(view.targetSafeListPriceUsd).toBe(47.8);
    expect(view.recommendedSalePriceUsd).toBe(47.8);
    expect(view.recommendedScenario?.listedSalePriceUsd).toBe(47.8);
    expect(view.recommendedScenario?.discountedSalePriceUsd).toBe(43.02);
    expect(view.recommendedScenario?.productRevenueUsd).toBe(41.02);
    expect(view.recommendedScenario?.shipentegraImportBasisUsd).toBe(41.02);
    expect(view.recommendedScenario?.shipentegraDutyUsd).toBe(4.1);
    expect(view.recommendedScenario?.shipentegraImportTotalUsd).toBe(4.1);
    expect(view.recommendedScenario?.totalCollectedUsd).toBe(46.02);
    expect(view.recommendedScenario?.dutyBaseUsd).toBe(41.02);
    ...
    expect(view.enteredPriceScenario?.shipentegraImportTotalUsd).toBe(3.31);
